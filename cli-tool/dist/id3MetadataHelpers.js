 ...
 */
export function iso6391To6392(code) {
    const mapping = {
        de: "deu",
        en: "eng",
        es: "spa",
 ...
 */
export function formatMultipleValues(values) {
 ...
 */
export function createTXXXFields(analysis) {
    const txxx = [];
    // Energy fields
 ...
 */
export function transformAnalysisToMetadata(analysis, commentStrategy = "tags+summary") {
    const metadata = {};
 ...
 */
export function mergeMetadata(existing, newMetadata, strategy = "keep-existing") {
 ...
 */
export function prepareMetadataForWriting(existingTags, newMetadata, strategy = "keep-existing") {
 ...
 */
export function normalizeMetadataForComparison(metadata) {
    if (!metadata)
        return metadata;
 ...
 */
export function formatMetadataForLog(tags) {
    if (!tags)
        return tags;
